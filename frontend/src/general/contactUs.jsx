      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20 contactReveal">
          ...
          <p className="mt-6 text-white/60 max-w-2xl mx-auto text-lg">
            Let’s build something meaningful together. Whether it’s feedback,
            collaboration, or just a hello — I’d love to hear from you.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="contactReveal space-y-8">
            ...
            <div className="space-y-6">
              ...
              >
                <span>Instagram</span>
                <span className="opacity-50 group-hover:translate-x-2 transition">
                  →
                </span>
              </a>
