    ...
    >
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center text-center px-6">
        ...
        <p className="reveal mt-8 max-w-3xl text-lg text-white/70">
          In a world of fast scrolling and temporary stories, we wanted to build
          something timeless.
        </p>
      </section>
      ...
      <section className="reveal py-32 px-6 text-center">
        <div className="max-w-4xl mx-auto text-xl text-white/70 leading-relaxed space-y-8">
          <p>
            This platform was born from a simple idea: What if memories felt
            like movies?
          </p>

          <p>
            What if you could tell someone how much they mean to you — not with
            a post, but with a journey.
          </p>

          <p>
            Smooth transitions. Background music. Scroll-driven storytelling.
            Emotional design.
          </p>
        </div>
      </section>
      ...
      <section className="reveal py-32 px-6 bg-black/40 text-center">
        <h2 className="text-4xl font-semibold mb-16">What Drives Us</h2>
      ...
      <section className="reveal py-40 px-6 text-center">
        <h2 className="text-5xl font-bold mb-10">This Is Just The Beginning</h2>

        <p className="max-w-3xl mx-auto text-white/60 text-lg">
          We're building a new way to experience digital emotion — where
          storytelling feels cinematic, personal and alive.
        </p>
      </section>
