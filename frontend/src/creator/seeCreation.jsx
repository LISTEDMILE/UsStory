...
export default function SeeCreation() {
  ...
  useGSAP(
    () => {
      ...
      gsap.utils.toArray(".moment").forEach((card) => {
        ...
        innerTl
          .from(card.querySelector(".innerTitle"), {
            y: 40,
            opacity: 0,
            duration: 0.6,
            ease: "power3.out",
          ...
          .from(
            card.querySelector(".innerDescription"),
            {
              y: 30,
              opacity: 0,
              duration: 0.6,
  ...
  return (
    ...
    >
      ...
      {/* ===== MUSIC ===== */}
      {selectedTrack && <audio ref={audioRef} src={selectedTrack.file} loop />}
      ...
      <section className="headTrigger relative h-[600vh]  flex justify-center  ">
        ...
        <div className="fixed flex justify-center items-center w-screen h-screen inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.08),transparent_70%)]">
          ...
          <p
            className="headName absolute  flex flex-col justify-center items-center gap-6 opacity-80 w-[80vw]
  ...
  text-white/70"
          >
            ...
            <span
              className="
  text-xl md:text-7xl w-full text-wrap
  font-light 
  text-white 
  tracking-wide"
            >
          ...
          <p className="headMessage absolute fade-up mt-10 w-[90vw] max-w-3xl text-md md:text-xl leading-relaxed">
            {creation.message}
          </p>
        </div>
      ...
      <section className="triggerAnimateTimeline h-[5000px] ">
        <div className="fixed flex w-screen h-[100dvh] justify-between items-center inset-0">
                ...
                <div key={i} className=" moment relative">
                  ...
                  >
                    ...
                    <div className="w-full md:w-1/2 p-4 md:p-10">
                      ...
                      <p className="innerDescription mt-6 text-md md:text-lg leading-relaxed opacity-90">
                        {moment.description}
                      </p>
                    </div>
                  </div>
      ...
      {creation.closingNote && (
        <section className=" parentClosingPara flex min-h-[60vh] items-center justify-center px-6 text-center">
          <div className="fade-up max-w-3xl">
            <p className="closingPara text-md md:text-2xl italic opacity-90">
              “{creation.closingNote}”
            </p>
          </div>
        </section>
